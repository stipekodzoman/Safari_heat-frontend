...
const get_general_winning=(result1:String[],result2:String[],result3:String[],result4:String[],result5:String[],line:number,betValue:number)=>{
    ...
    for (let index=0;index<PAYLINES.length;index++){
        ...
        if (result1[PAYLINES[index][0]]==="lion"&&result2[PAYLINES[index][1]]==="lion"){
            wild_winning_count=2
            wild_winning=betValue/line*10
            if(result1[PAYLINES[index][0]]==="lion"&&result3[PAYLINES[index][2]]==="lion"){
                wild_winning_count=3
                wild_winning=betValue/line*250
                if(result1[PAYLINES[index][0]]==="lion"&&result4[PAYLINES[index][3]]==="lion"){
                    wild_winning_count=4
                    wild_winning=betValue/line*2500
                    if(result1[PAYLINES[index][0]]==="lion"&&result5[PAYLINES[index][4]]==="lion"){
            ...
            if(result2[PAYLINES[index][1]]==="elephant"){
                ...
                if(result3[PAYLINES[index][2]]==="elephant"||result3[PAYLINES[index][2]]==="lion"){
                    ...
                    if(result4[PAYLINES[index][3]]==="elephant"||result4[PAYLINES[index][3]]==="lion"){
                        general_winning_count=4
                        general_winning=betValue/line*125*2
                        if(result5[PAYLINES[index][4]]==="elephant"||result5[PAYLINES[index][4]]==="lion"){
            ...
            if(result2[PAYLINES[index][1]]==="rhino"){
                ...
                if(result3[PAYLINES[index][2]]==="rhino"||result3[PAYLINES[index][2]]==="lion"){
                    general_winning_count=3
                    general_winning=betValue/line*25*2
                    if(result4[PAYLINES[index][3]]==="rhino"||result4[PAYLINES[index][3]]==="lion"){
                        general_winning_count=4
                        general_winning=betValue/line*125*2
                        if(result5[PAYLINES[index][4]]==="rhino"||result5[PAYLINES[index][4]]==="lion"){
                            general_winning_count=5
                            general_winning=betValue/line*750*2
                        }
                    }
            ...
            if(result2[PAYLINES[index][1]]==="zebra"){
                if(result3[PAYLINES[index][2]]==="zebra"||result3[PAYLINES[index][2]]==="lion"){
                    ...
                    if(result4[PAYLINES[index][3]]==="zebra"||result4[PAYLINES[index][3]]==="lion"){
                        general_winning_count=4
                        general_winning=betValue/line*75*2
                        if(result5[PAYLINES[index][4]]==="zebra"||result5[PAYLINES[index][4]]==="lion"){
                            general_winning_count=5
            ...
            if(result2[PAYLINES[index][1]]==="bison"){
                if(result3[PAYLINES[index][2]]==="bison"||result3[PAYLINES[index][2]]==="lion"){
                    general_winning_count=3
                    general_winning=betValue/line*15*2
                    if(result4[PAYLINES[index][3]]==="bison"||result4[PAYLINES[index][3]]==="lion"){
                        general_winning_count=4
                        general_winning=betValue/line*75*2
                        if(result5[PAYLINES[index][4]]==="bison"||result5[PAYLINES[index][4]]==="lion"){
                            general_winning_count=5
                            general_winning=betValue/line*250*2
                        }
                    }
            ...
            if(result2[PAYLINES[index][1]]==="flamingo"){
                if(result3[PAYLINES[index][2]]==="flamingo"||result3[PAYLINES[index][2]]==="lion"){
                    ...
                    if(result4[PAYLINES[index][3]]==="flamingo"||result4[PAYLINES[index][3]]==="lion"){
                        general_winning_count=4
                        general_winning=betValue/line*100*2
                        if(result5[PAYLINES[index][4]]==="flamingo"||result5[PAYLINES[index][4]]==="lion"){
                            general_winning_count=5
            ...
            if(result2[PAYLINES[index][1]]==="king"){
                if(result3[PAYLINES[index][2]]==="king"||result3[PAYLINES[index][2]]==="lion"){
                    ...
                    if(result4[PAYLINES[index][3]]==="king"||result4[PAYLINES[index][3]]==="lion"){
                        general_winning_count=4
                        general_winning=betValue/line*40*2
                        if(result5[PAYLINES[index][4]]==="king"||result5[PAYLINES[index][4]]==="lion"){
                            general_winning_count=5
            ...
            if(result2[PAYLINES[index][1]]==="ace"){
                if(result3[PAYLINES[index][2]]==="ace"||result3[PAYLINES[index][2]]==="lion"){
                    general_winning_count=3
                    general_winning=betValue/line*10*2
                    if(result4[PAYLINES[index][3]]==="ace"||result4[PAYLINES[index][3]]==="lion"){
                        general_winning_count=4
                        general_winning=betValue/line*40*2
                        if(result5[PAYLINES[index][4]]==="ace"||result5[PAYLINES[index][4]]==="lion"){
                            general_winning_count=5
                            general_winning=betValue/line*150*2
                        }
                    }
            ...
            if(result2[PAYLINES[index][1]]==="queen"){
                if(result3[PAYLINES[index][2]]==="queen"||result3[PAYLINES[index][2]]==="lion"){
                    ...
                    if(result4[PAYLINES[index][3]]==="queen"||result4[PAYLINES[index][3]]==="lion"){
                        general_winning_count=4
                        general_winning=betValue/line*30*2
                        if(result5[PAYLINES[index][4]]==="queen"||result5[PAYLINES[index][4]]==="lion"){
                            general_winning_count=5
                            general_winning=betValue/line*125*2
                        }
                    }
            ...
            if(result2[PAYLINES[index][1]]==="jack"){
                if(result3[PAYLINES[index][2]]==="jack"||result3[PAYLINES[index][2]]==="lion"){
                    general_winning_count=3
                    general_winning=betValue/line*5*2
                    if(result4[PAYLINES[index][3]]==="jack"||result4[PAYLINES[index][3]]==="lion"){
                        general_winning_count=4
                        general_winning=betValue/line*25*2
                        if(result5[PAYLINES[index][4]]==="jack"||result5[PAYLINES[index][4]]==="lion"){
                            general_winning_count=5
                            general_winning=betValue/line*100*2
                        }
                    }
            ...
            if(result2[PAYLINES[index][1]]==="ten"){
                if(result3[PAYLINES[index][2]]==="ten"||result3[PAYLINES[index][2]]==="lion"){
                    general_winning_count=3
                    general_winning=betValue/line*5*2
                    if(result4[PAYLINES[index][3]]==="ten"||result4[PAYLINES[index][3]]==="lion"){
                        general_winning_count=4
                        general_winning=betValue/line*25*2
                        if(result5[PAYLINES[index][4]]==="ten"||result5[PAYLINES[index][4]]==="lion"){
                            general_winning_count=5
                            general_winning=betValue/line*100*2
                        }
                    }
            ...
            if(result2[PAYLINES[index][1]]==="nine"){
                ...
                if(result3[PAYLINES[index][2]]==="nine"||result3[PAYLINES[index][2]]==="lion"){
                    general_winning_count=3
                    general_winning=betValue/line*5*2
                    if(result4[PAYLINES[index][3]]==="nine"||result4[PAYLINES[index][3]]==="lion"){
                        general_winning_count=4
                        general_winning=betValue/line*25*2
                        if(result5[PAYLINES[index][4]]==="nine"||result5[PAYLINES[index][4]]==="lion"){
                            general_winning_count=5
                            general_winning=betValue/line*100*2
                        }
                    }
