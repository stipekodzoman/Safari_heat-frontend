  ...
  const login=async()=>{
    try{
      ...
      if(result.success==false){
        ...
        dispatch({type:"LOGIN_SUCCESS", username:username, token:result.accessToken})
        navigate("/safari")
      }
    }catch(err){
      console.log(err)
    ...
    >
      ...
      >
        <div className="flex flex-col justify-center 2xl:gap-[61px] xl:gap-[45px] gap-[27px] 2xl:mt-[39px] 2xl:px-[81px] xl:mt-[30px] xl:px-[56px] mt-[17px] px-[24px]">
          <input id="username" onChange={handleChange} className="2xl:ml-[232px] xl:ml-[176px] ml-[105px] pl-2 2xl:h-[62px] xl:h-[46px] h-[24px] 2xl:text-[32px] xl:text-[22px] text-white xl:rounded-xl rounded-md border-2 border-black bg-[#0C0142]" />
          <input id="password" type="password" onChange={handleChange} className="2xl:ml-[232px] xl:ml-[176px] ml-[105px] pl-2 2xl:h-[62px] xl:h-[46px] h-[24px] 2xl:text-[32px] xl:text-[22px] text-white xl:rounded-xl rounded-md border-2 border-black bg-[#0C0142]" />
        </div>
